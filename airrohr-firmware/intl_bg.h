...
const char INTL_PM_SENSOR[] PROGMEM = "Сензор за прахови частици";
const char INTL_CONFIGURATION[] PROGMEM = "Конфигурация";
const char INTL_WIFI_SETTINGS[] PROGMEM = "Настройки за WiFi";
const char INTL_WIFI_NETWORKS[] PROGMEM = "Зареждането WiFi мрежи ...";
const char INTL_LANGUAGE[] PROGMEM = "Език";
...
const char INTL_HDC1080[] PROGMEM = "HDC1080 ({t}, {h})";
...
const char INTL_HOME[] PROGMEM = "Начало";
const char INTL_BACK_TO_HOME[] PROGMEM = "Обратно към начало";
const char INTL_CURRENT_DATA[] PROGMEM = "Текущи данни";
const char INTL_ACTIVE_SENSORS_MAP[] PROGMEM = "Карта на активните сензори (външен линк)";
const char INTL_CONFIGURATION_DELETE[] PROGMEM = "Изтриване на Конфигурацията";
const char INTL_CONFIGURATION_REALLY_DELETE[] PROGMEM = "Наистина ли искате да изтриете конфигурацията?";
const char INTL_DELETE[] PROGMEM = "Изтрий";
const char INTL_CANCEL[] PROGMEM = "Отказ";
const char INTL_REALLY_RESTART_SENSOR[] PROGMEM = "Наистина ли искате да рестартирате сензора?";
const char INTL_RESTART[] PROGMEM = "Рестарт";
...
const char INTL_CONFIG_DELETED[] PROGMEM = "Конфигурацията е изтрита";
const char INTL_CONFIG_CAN_NOT_BE_DELETED[] PROGMEM = "Конфигурацията не може да бъде изтрита";
const char INTL_CONFIG_NOT_FOUND[] PROGMEM = "Конфигурацията не е открита";
...
const char INTL_NUMBER_OF_MEASUREMENTS[] PROGMEM = "Брой измервания";
const char INTL_SENSOR[] PROGMEM = "Сензор";
const char INTL_PARAMETER[] PROGMEM = "Параметър";
const char INTL_VALUE[] PROGMEM = "Стойност";
